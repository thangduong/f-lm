...
#train
python3 single_lm_train.py --logdir=./$LOGSUFFIX --num_gpus=4 --datadir=../1-billion-word-language-modeling-benchmark/ \
         --hpconfig run_profiler=False,float16_rnn=False,max_time=$SECONDS,num_steps=20,num_shards=4,num_layers=2,learning_rate=0.2,max_grad_norm=1,keep_prob=0.9,emb_size=1024,projected_size=1024,state_size=8192,num_sampled=8192,batch_size=64 \
